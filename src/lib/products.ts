...
export const productCategories: ProductCategory[] = [
  ...
  },
  {
    ...
    products: [
      { name: 'Diaries & Notebooks', image: 'https://images.unsplash.com/photo-1653569693215-3b1fc81d2b7f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw5fHxsZWF0aGVyJTIwbm90ZWJvb2t8ZW58MHx8fHwxNzU0OTE4OTY4fDA&ixlib=rb-4.1.0&q=80&w=1080', hint: 'leather notebook' },
      { name: 'Chit Pads & Memo Blocks', image: 'https://images.unsplash.com/photo-1565799284935-da1e43e7944e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw1fHxtZW1vJTIwcGFkc3xlbnwwfHx8fDE3NTQ5MTg5Njh8MA&ixlib=rb-4.1.0&q=80&w=1080', hint: 'memo pads' },
      { name: 'Letterheads & Envelopes', image: 'https://images.unsplash.com/photo-1710352461686-3cbbf1862caa?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw0fHxzdGF0aW9uZXJ5JTIwc2V0fGVufDB8fHx8MTc1NDkxODk2N3ww&ixlib=rb-4.1.0&q=80&w=1080', hint: 'stationery set' },
      { name: 'Presentation Folders', image: 'https://images.unsplash.com/photo-1699462516277-7294d37e5cc3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxMHx8ZG9jdW1lbnQlMjBmb2xkZXJ8ZW58MHx8fHwxNzU0OTE4OTY3fDA&ixlib=rb-4.1.0&q=80&w=1080', hint: 'document folder' },
      { name: 'Planners', image: 'https://images.unsplash.com/photo-1558478551-08d1b7078b94?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxMHx8ZGFpbHklMjBwbGFubmVyfGVufDB8fHx8MTc1NDkxODk2N3ww&ixlib=rb-4.1.0&q=80&w=1080', hint: 'daily planner' },
      { name: 'Calendars', image: 'https://images.unsplash.com/photo-1686563873984-9ee2048d1c52?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw2fHxkZXNrJTIwY2FsZW5kYXJ8ZW58MHx8fHwxNzU0OTE4OTY4fDA&ixlib=rb-4.1.0&q=80&w=1080', hint: 'desk calendar' },
      { name: 'Luxury Pens', image: 'https://images.unsplash.com/photo-1462642109801-4ac2971a3a51?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw3fHxmb3VudGFpbiUyMHBlbnxlbnwwfHx8fDE3NTQ5MTg5Njd8MA&ixlib=rb-4.1.0&q=80&w=1080', hint: 'fountain pen' },
      { name: 'Portfolios', image: 'https://images.unsplash.com/photo-1647036886496-da7c0f9f1a45?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwzfHxsZWF0aGVyJTIwcG9ydGZvbGlvfGVufDB8fHx8MTc1NDkxODk2N3ww&ixlib=rb-4.1.0&q=80&w=1080', hint: 'leather portfolio' },
    ],
  },
];
